...
const ModalFilterEvents = (props: Props) => {
  ...
  const handleFilter = () => {
    // onFilter(
    //   `/get-events-by-categoryid?${categorySelected.length>0? `categoryId=${categorySelected.toString()}&`:``}${
                    ...
                    <TouchableOpacity
                      style={[
                        globalStyles.center,
                        {
                          width: 63,
                          height: 63,
                          backgroundColor: categorySelected.includes(item.key)
                            ? item.color
                            : appColors.white,
                          borderWidth: 1,
                      ...
                      <Image
                        source={{
                          uri: categorySelected.includes(item.key)
                            ? item.iconWhite
                            : item.iconColor,
                        }}
