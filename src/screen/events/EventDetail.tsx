                ...
                <LinearGradient colors={['rgba(0,0,0,0.7)', 'rgba(0,0,0,0)']}>
                    <RowComponent styles={{
                        ...
                        <CardComponent
                            ...
                            color='#ffffff4D'>
                            <MaterialIcons name='bookmark' color={appColors.white} size={22} />
                        </CardComponent>
                    </RowComponent>
                        ...
                        <SectionComponent>
                            <RowComponent styles = {{marginBottom:20}}>
                                ...
                                <View style={{ flex: 1, height:48, justifyContent:'space-around' }}>
                                    <TextComponent text='14 December,2021' font={fontFamilies.medium} size={16} />
                            ...
                            <RowComponent styles = {{marginBottom:20}}>
                                ...
                                <SpaceComponent width={16} />
                                <View style={{ flex: 1, height:48, justifyContent:'space-around' }}>
                                    <TextComponent text={item.location.title} font={fontFamilies.medium} size={16} />
                                    <TextComponent text={item.location.address} color={appColors.gray}/>
                                </View>
                            </RowComponent>
                            <RowComponent styles = {{marginBottom:20}}>
